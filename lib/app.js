var Promise, chalk, exif, exifdate, fs, getFileStat, getFiles, getPhotoDate, isJpg, isPhoto, log, mkdirp, moment, path, processError, readChunk, sortPhotos, _;
...
sortPhotos = function(sortable, workingDirectory, outputDirectory) {
  var directories;
...
module.exports = function(args, opts) {
  ...
  return getFiles(workingDirectory).filter(function(file) {
    ...
    return sortPhotos(sortable, workingDirectory, outputDirectory);
  }).then(function() {
