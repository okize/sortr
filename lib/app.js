var Promise, chalk, createDirectories, exif, exifdate, fs, getFiles, getPhotoDate, isFile, isJpg, isPhoto, log, mkdirp, moment, path, processError, readChunk, _;
...
module.exports = function(args, opts) {
  ...
  return getFiles(workingDirectory).filter(function(file) {
    ...
    return createDirectories(_.keys(sortable).map(function(dir) {
